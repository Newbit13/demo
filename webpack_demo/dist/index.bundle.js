...
var _map = _interopRequireDefault(__webpack_require__(2));
...
var a = 'const';
var arr = (0, _map["default"])(_context = [1, 2, 3, 4]).call(_context, function (item) {
  return item * item;
});
console.log(arr);
console.log(a);
b(); // console.log("".padStart(10,"h"));
// let a = new Map();
// a.set('z',1);
// console.log(a.get('z'));
// const a = ()=>{
...
// console.log(233);/*copy@ newbit end*/
}();
/******/ })()
;