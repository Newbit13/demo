                ...
                <div>
                    ...
                    <WingBlank>
                        <List>
                            ...
                            <WhiteSpace />
                            <InputItem placeholder='请确认密码' type="password" onChange={(val)=>{this.handlerChange('password2',val)}}>确认密码</InputItem>
                            <WhiteSpace />
                            <ListItem>
                                <span>身&nbsp;&nbsp;&nbsp;份</span>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <Radio name='type' checked={type==='dashen'} onChange={(val)=>{this.handlerChange('type','dashen')}}>大神</Radio>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <Radio name='type' checked={type==='laoban'} onChange={(val)=>{this.handlerChange('type','laoban')}}>老板</Radio>
                            </ListItem>
                            <WhiteSpace />
                            <Button type="primary" onClick={this.handlerRegister}>注册</Button>
                            <WhiteSpace />
                            <Button onClick={()=>{this.props.history.push('/login')}} >已有账号</Button>
                        </List>
                    </WingBlank>
                </div>
            )
